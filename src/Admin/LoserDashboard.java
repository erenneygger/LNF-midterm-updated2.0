 ...
 * @author USER27
 */
public class LoserDashboard extends javax.swing.JFrame {

    /**
     * Creates new form teacherDashboard
     */
    public LoserDashboard() {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(LoserDashboard.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
