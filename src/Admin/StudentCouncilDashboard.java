 ...
 * @author USER27
 */
public class StudentCouncilDashboard extends javax.swing.JFrame {

    /**
     * Creates new form user
     */
    public StudentCouncilDashboard() {
    ...
    private void initComponents() {
        ...
        jPanel2.add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(100, 20, -1, 104));

        jLabel8.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Images/image-removebg-preview.png"))); // NOI18N
        jPanel2.add(jLabel8, new org.netbeans.lib.awtextra.AbsoluteConstraints(790, -30, -1, -1));
    ...
    // 2. Close the current Student Council Dashboard
    this.dispose();
   ...
   report reportsFrame = new report(); 
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(StudentCouncilDashboard.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
